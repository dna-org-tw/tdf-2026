...
避免 Luma sync 在活動前最後一刻才把人 approve，造成參加者沒時間準備。引入「approve cutoff」三個固定時鐘（GMT+8）：`00:00` / `06:00` / `12:00`，分別對應「當日早上 / 當日下午 / 當日晚上」三個時段的活動。
...
- 早上活動 `2026-05-10T01:00:00+08:00` → cutoff `2026-05-10T00:00+08:00`
- 早上活動 `2026-05-10T11:59:00+08:00` → cutoff `2026-05-10T00:00+08:00`
