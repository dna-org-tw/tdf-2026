export const content = {
  en: {
    ...
    auth: {
      loginTitle: "Sign In",
      loginDescription: "Enter your email to receive a magic link for instant sign-in. No password needed.",
      emailPlaceholder: "your@email.com",
      sendLink: "Send Magic Link",
      sending: "Sending...",
      successTitle: "Check Your Email",
      successMessage: "We've sent a login link to your email. Click the link to sign in.",
  ...
  zh: {
    ...
    auth: {
      loginTitle: "登入",
      loginDescription: "輸入您的電子郵件，我們將發送一封包含登入連結的郵件。無需密碼。",
      emailPlaceholder: "your@email.com",
      sendLink: "發送登入連結",
      sending: "發送中...",
      successTitle: "請檢查您的信箱",
      successMessage: "我們已將登入連結發送至您的信箱，點擊連結即可登入。",
      errorMessage: "發送登入連結失敗，請稍後再試。",
      logout: "登出",
      memberTitle: "我的帳戶",
      orderHistory: "訂單紀錄",
      noOrders: "目前沒有任何訂單。",
