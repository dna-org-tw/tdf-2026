export const content = {
  en: {
    ...
    auth: {
      ...
      rateLimitedMessage: "Too many attempts. Please wait {minutes} minute(s) and try again.",
      logout: "Sign Out",
        ...
        items: [
          {
            ...
            tagline: "Hotels & monthlies from 2 weeks",
    ...
    schedule: {
      title: "Event Timeline",
      themeWeekLabel: "Theme Week",
      weekThemes: [
        "Regional Revitalization & Startups",
        "Art, Humanities & Design",
        "Culture, Tourism & Experience",
        "Technology, Remote & Co-creation",
        "Tour",
      ],
      filterLabel: "Filter by ticket type:",
      explorer: "Explorer",
    ...
    terms: {
      ...
      lastUpdated: "Last updated: April 2026",
      intro: "These Terms of Service (\"Terms\") govern your use of www.taiwandigitalfest.com/2026 (the \"Site\") and your participation in Taiwan Digital Fest 2026 (\"TDF 2026\"). By purchasing a ticket, registering an account, or using the Site, you agree to these Terms. If you do not agree, do not use the Site or attend the event. The Site and TDF 2026 are jointly operated by Taiwan Digital Nomad Association (\"TDNA\", Taiwan) and Nomad Explore LLC (Wyoming, USA).",
      sections: [
        {
    ...
    orderQuery: {
      title: "Order Query",
      description: "Enter your order ID or email to view your order details and payment status.",
      tabOrderId: "Order ID",
      tabEmail: "Email",
      orderIdLabel: "Order ID",
      ...
      emailHint: "Enter the email address you used when placing your order.",
      emailRequired: "Please enter an email address.",
      queryButton: "Query Order",
      querying: "Querying...",
      queryError: "Failed to query order. Please try again.",
      noOrdersFound: "No orders found for this email address.",
      resultsTitle: "Orders Found",
      resultsDescription: "Select an order to view its details.",
      orderDate: "Date",
      orderAmount: "Amount",
      orderStatus: "Status",
      statusPaid: "Paid",
      statusUnpaid: "Unpaid",
      statusNoPaymentRequired: "No Payment Required",
    ...
    stay: {
      ...
      cutoffNote: 'Booking closes at 23:59 (Taiwan time), 8 calendar days before check-in.',
      ...
      inventoryTitle: 'Weekly inventory',
      capacityLabel: 'Total rooms',
      remainingLabel: 'rooms left',
      almostFullLabel: 'Almost full',
      soldOutLabel: 'Sold out',
      bookingClosedLabel: 'Booking closed',
      bookingClosedNote: 'Booking for this week is closed — the cutoff has passed and the waitlist is no longer accepting entries.',
      bookingCutoffPrefix: 'Closes',
      perWeekLabel: 'for 7 nights',
      roomEyebrow: 'Room type',
      roomName: 'Mini Single Room',
      roomSubname: 'Norden Ruder Hostel · Taitung',
      roomDescription: [
        ...
        'For TDF 2026, this room is offered as a private single room — spacious for one nomad to work and rest by the coast.',
        'It includes a double size mattress (150×180 cm), shampoo, body wash, bath towel(s), a hair dryer, mug(s), hangers, vent windows and free WIFI.',
      ],
      roomSpecsTitle: 'At a glance',
      roomSpecSize: { label: 'Size', value: '8 ㎡' },
      roomSpecCapacity: { label: 'Occupancy', value: '1 guest' },
      roomSpecBed: { label: 'Bed', value: 'One double bed (150×180 cm)' },
      roomAmenitiesTitle: 'In the room',
      roomAmenities: [
        'En-suite shower',
        'Double size mattress (150×180 cm)',
        'Shampoo (O\u2019right)',
        'Body wash (O\u2019right)',
        'Bath towel(s)',
        'Hair dryer',
      ...
      roomNotesTitle: 'Please note',
      roomNotes: [
        'Single occupancy — one guest per room; no extra bed, no additional guest.',
        'Not suitable for children under 12 years old.',
        'No TV. No toothbrush nor toothpaste.',
        'No smoking throughout the property.',
      ],
      roomAddress: 'No. 162, Guangdong Rd., Taitung City, 950 Taiwan',
      roomSource: 'Content and photos from Norden Ruder Hostel official site.',
      roomLinkLabel: 'View full room details on Norden Ruder',
    },
  },
  zh: {
    hero: {
    ...
    auth: {
      ...
      rateLimitedMessage: "嘗試次數過多，請於 {minutes} 分鐘後再試。",
      logout: "登出",
      memberTitle: "我的帳戶",
      orderHistory: "訂單紀錄",
      noOrders: "目前沒有任何訂單。",
    ...
    terms: {
      title: "服務條款",
      lastUpdated: "最後更新：2026 年 4 月",
      intro: "本服務條款（「條款」）規範您使用 www.taiwandigitalfest.com/2026（「網站」）及參與 Taiwan Digital Fest 2026（「TDF 2026」）之行為。您購票、註冊帳號或使用本網站即表示同意本條款。若您不同意，請勿使用本網站或出席活動。本網站與 TDF 2026 由社團法人台灣數位遊牧者協會（「TDNA」，台灣）與 Nomad Explore LLC（美國懷俄明州）共同營運。",
      sections: [
        {
          title: "1. 當事人與適用範圍",
          paragraphs: [
    ...
    orderQuery: {
      title: "查詢訂單",
      description: "輸入您的訂單 ID 或 Email 以查看訂單詳情和付款狀態。",
      tabOrderId: "訂單 ID",
      tabEmail: "Email",
      orderIdLabel: "訂單 ID",
      ...
      emailLabel: "Email",
      emailPlaceholder: "請輸入下單時使用的 Email",
      emailHint: "請輸入您下單時使用的電子信箱。",
      emailRequired: "請輸入 Email。",
      queryButton: "查詢訂單",
      querying: "查詢中...",
      queryError: "查詢訂單失敗，請稍後再試。",
      noOrdersFound: "找不到與此 Email 相關的訂單。",
      resultsTitle: "查詢結果",
      resultsDescription: "選擇一筆訂單以查看詳情。",
      orderDate: "日期",
      orderAmount: "金額",
      orderStatus: "狀態",
      statusPaid: "已付款",
      statusUnpaid: "未付款",
      statusNoPaymentRequired: "無需付款",
      viewOrder: "查看詳情",
      backToSearch: "返回查詢",
    ...
    stay: {
      ...
      cutoffNote: '入住前八個日曆日晚間 23:59（台灣時間）截止訂房。',
      ...
      capacityLabel: '總房數',
      remainingLabel: '間可訂',
      almostFullLabel: '即將額滿',
      soldOutLabel: '已額滿',
      bookingClosedLabel: '訂房已截止',
      bookingClosedNote: '此週已超過訂房截止時間，無法再訂房，也不再開放加入候補名單。',
      bookingCutoffPrefix: '截止',
      perWeekLabel: '共 7 晚',
      roomEyebrow: '房型介紹',
      roomName: '輕旅單人房',
      roomSubname: 'Norden Ruder 諾丁漢背包客棧 · 台東',
      roomDescription: [
        '不同於傳統上下舖，提供個人空間作為輕旅背包客休息的地方。在有限的預算內還可以擁有私人衛浴設備、也不用再與別人摩肩擦踵，排隊洗澡。',
        'TDF 2026 合作案僅推出單人房型——整週入住、一人一房，讓你在太平洋旁安心工作與休息。',
        '房間提供：雙人床墊(150*180cm)，洗髮乳、沐浴乳、大毛巾、吹風機、馬克杯、衣架、氣窗、免費 WIFI。',
      ],
      roomSpecsTitle: '房型規格',
      roomSpecSize: { label: '坪數', value: '2.5 坪' },
      roomSpecCapacity: { label: '入住人數', value: '1 人' },
      roomSpecBed: { label: '床型', value: '一大床（150×180 cm）' },
      roomAmenitiesTitle: '房內配備',
      roomAmenities: [
        '雙人床墊(150*180cm)',
        '洗髮乳',
        '沐浴乳',
      ...
      roomAddress: '臺東市廣東路 162 號',
      roomSource: '內容與圖片取自諾丁漢背包客棧官方網站。',
      roomLinkLabel: '前往 Norden Ruder 官網查看完整房型介紹',
    },
  }
};
