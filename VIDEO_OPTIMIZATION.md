...
```bash
# 使用 ffmpeg 轉換
ffmpeg -i tdf2025_short.mov -c:v libvpx-vp9 -crf 30 -b:v 0 -c:a libopus -b:a 128k tdf2025_short.webm
...
```bash
# 從視頻第一幀提取圖片
ffmpeg -i tdf2025_short.mov -ss 00:00:01 -vframes 1 -q:v 2 tdf2025_short_poster.webp
