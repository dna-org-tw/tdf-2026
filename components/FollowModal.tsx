...
const WHATSAPP_COMMUNITY_URL = 'https://chat.whatsapp.com/KZsFo7oNvZVCPIF86imk0E';
              ...
              <div className="p-6 text-center">
                ...
                {(type === 'success' || type === 'duplicate') && (
                  <a
                    ...
                    className="mt-4 w-full flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#25D366]/90 text-white font-semibold px-6 py-3 rounded-xl transition-all shadow-md shadow-[#25D366]/40"
                  >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="mt-3 w-full bg-[#10B8D9] hover:bg-[#10B8D9]/90 text-white font-semibold px-6 py-3 rounded-xl transition-all shadow-md shadow-[#10B8D9]/40"
                >
